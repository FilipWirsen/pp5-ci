...
I used [soovle](https://soovle.com) to find good keywords to use throughout the website. I then googled theese words to see what type of websites that were showing up. As expected alot of stores and courses were showing up so I knew I had a few good keywords such as Disc golf, Disc golf discs, Disc golf courses, Disc golf putter, Disc golf accessories, Disc golf set, Disc golf bag, Disc golf lover, Disc golf driver, Disc golf midrange, Disc golf fairway, Disc golf bundles.

I added all of theese keywords to my metadata at the top of my base.html file
<img src="readme_assets/metadata.png">

I also added rel="noopener" to my external link to the facebook page in the footer and rel="external" to the external links on the course reviews page.
Beside this i also changed the text 'Deals' and 'Course Reviews' in the navbar to 'Disc Golf Deals' and 'Disc Golf Courses'. I also added the html tag <em>em</em> to the products detail page product name since alot of the products will have good keywords in their name.
